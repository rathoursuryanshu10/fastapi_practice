...
class Patient(BaseModel):
    name: str = Annotated[str, Field(max_length=50, title="Patient Name", description="The full name of the patient")]
    email: EmailStr
...
patient_info = {'name': "John Doe", 'email': 'john.doe@example.com', 'linked_in': 'https://www.linkedin.com/in/johndoe', 'age': 30, 'weight': 70.5, 'married': True, 'allergies': ['penicillin', 'peanuts'], 'contact_details': {'email': 'john.doe@example.com', 'phone_no': '123-456-7890'}}
