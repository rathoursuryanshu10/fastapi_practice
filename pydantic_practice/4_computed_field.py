...
patient_info = {'name': "John Doe", 'email': 'john.doe@example.com', 'linked_in': 'https://www.linkedin.com/in/johndoe', 'age': 61, 'weight': 70.5, 'height': 175.0, 'married': True, 'allergies': ['penicillin', 'peanuts'], 'contact_details': {'email': 'john.doe@example.com', 'phone_no': '123-456-7890','emergency': '987-654-3210'}}
...
def insert_patient_data(patient_data: Patient):
    ...
    print(f"Height: {patient_data.height}")
    print(f"BMI: {patient_data.calculate_bmi}")
